!define PRODUCT_NAME "Checklist reader"
!define PRODUCT_VERSION "0.1"
!define PY_VERSION "3.11.6"
!define PY_MAJOR_VERSION "3.11"
!define BITNESS "64"
!define ARCH_TAG ".amd64"
!define INSTALLER_NAME "Checklist_reader_0.1.exe"
!define PRODUCT_ICON "logo64.ico"
...
!define MULTIUSER_INSTALLMODE_INSTDIR "Checklist reader"
...
!define MUI_ICON "logo64.ico"
!define MUI_UNICON "logo64.ico"
...
Section "!${PRODUCT_NAME}" sec_app
  ...
  StrCmp $MultiUser.InstallMode CurrentUser 0 +3
    ...
    SetFileAttributes "$INSTDIR\${USER_INSTALL_MARKER}" HIDDEN
      ...
      ; Install files
    SetOutPath "$INSTDIR"
      File "Checklist_reader.launch.pyw"
      File "logo64.ico"
      File "LICENSE.txt"
      File "README.md"
      File "empty.mp3"
  ...
  SetOutPath "%HOMEDRIVE%\%HOMEPATH%"
    CreateShortCut "$SMPROGRAMS\Checklist reader.lnk" "$INSTDIR\Python\pythonw.exe" \
      '"$INSTDIR\Checklist_reader.launch.pyw"' "$INSTDIR\logo64.ico"
  SetOutPath "$INSTDIR"
...
Section "Uninstall"
  ...
  ; Uninstall files
    Delete "$INSTDIR\Checklist_reader.launch.pyw"
    Delete "$INSTDIR\logo64.ico"
    Delete "$INSTDIR\LICENSE.txt"
    Delete "$INSTDIR\README.md"
    Delete "$INSTDIR\empty.mp3"
    Delete "$INSTDIR\hd.png"
    Delete "$INSTDIR\logo.png"
    Delete "$INSTDIR\speech.mp3"
  ...
  ; Uninstall shortcuts
      Delete "$SMPROGRAMS\Checklist reader.lnk"
  RMDir $INSTDIR
